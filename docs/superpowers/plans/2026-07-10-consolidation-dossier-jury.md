...
- [x] **Step 1:** Rédiger le document, trois sections :
  ...
  3. **Prévu en v1 mais non réalisé sous cette forme** — reprendre le tableau « Fonctions historiques non présentes » de [`inventaire-documents-historiques.md`](../../jury/inventaire-documents-historiques.md) en une ligne par écart avec sa justification produit (ex. : pas de candidature depuis une session école = anti-usurpation).
