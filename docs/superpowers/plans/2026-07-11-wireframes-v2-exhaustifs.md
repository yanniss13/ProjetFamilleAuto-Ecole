...
- [x] **Étape 1 — écrire le contrôle qui échoue sans les 30 écrans.** Le script
...
- [x] **Étape 2 — exécuter le contrôle et constater l'échec initial.**
...
- [x] **Étape 3 — créer le manifeste avec les 30 entrées et leurs sources.**
...
- [x] **Étape 4 — écrire le générateur et le kit CSS minimal.** Le layout doit
...
- [x] **Étape 5 — générer le sommaire et vérifier le socle.**
...
- [x] **Étape 1 — renseigner les contenus exacts des écrans 01 à 04.**
...
- [x] **Étape 2 — renseigner les alertes 05 à 08.** Abonnement : email,
...
- [x] **Étape 3 — renseigner l'authentification 09 à 13.** Connexion : email,
...
- [x] **Étape 4 — générer et vérifier les 13 fichiers.**
...
- [x] **Étape 5 — contrôler visuellement les écrans 02, 03, 04 et 09 dans Edge.**
...
- [x] **Étape 1 — modéliser les quatre états du suivi.** La structure partagée
...
- [x] **Étape 2 — modéliser la signature candidat.** Inclure résumé du contrat,
...
- [x] **Étape 3 — générer et contrôler les cinq états.**
...
- [x] **Étape 4 — contrôler visuellement les écrans 14, 15 et 16 à 1440/320 px.**
...
- [x] **Étape 1 — modéliser dashboard et annonces.** Dashboard : cinq tuiles,
...
- [x] **Étape 2 — modéliser création et modification.** Les deux variantes de
...
- [x] **Étape 3 — modéliser candidatures et contrat école.** Candidatures :
...
- [x] **Étape 4 — modéliser Mon compte.** Adresse avec liste de suggestions,
  téléphone et Enregistrer uniquement. Ne pas afficher changement de mot de
  passe, carte d'aperçu ni suppression du compte.

- [x] **Étape 5 — générer, vérifier et contrôler visuellement 19, 20, 23, 24.**
...
- [x] **Étape 1 — modéliser la connexion et le dashboard admin.** Connexion
...
- [x] **Étape 2 — modéliser la modération.** Écoles : pagination, nom, email,
...
- [x] **Étape 3 — modéliser la planche système.** Présenter flash succès/erreur,
...
- [x] **Étape 4 — générer et obtenir le contrôle complet vert.**
...
- [x] **Étape 5 — contrôler visuellement 27, 28, 29 et 30.** Vérifier la
...
- [x] **Étape 1 — écrire la matrice de couverture.** Une ligne par écran avec
...
- [x] **Étape 2 — écrire et exécuter le script de capture.** Edge headless ouvre
...
- [x] **Étape 3 — contrôler visuellement les 30 PNG.** Procéder par lots de
...
- [x] **Étape 4 — générer la planche SVG.** `build-board.cjs` produit un SVG
...
- [x] **Étape 5 — générer le PDF.** `build-pdf.py` utilise reportlab : page de
...
- [x] **Étape 6 — vérifier le PDF.** Utiliser pypdf pour confirmer 32 pages et
...
- [x] **Étape 7 — commiter les preuves.**
...
- [x] **Étape 1 — intégrer les liens.** README : ajouter Wireframes v2 avec
...
- [x] **Étape 2 — vérifier tous les liens relatifs des fichiers touchés.** Un
...
- [x] **Étape 3 — vérifier les chemins interdits.** Comparer avec le commit
...
- [x] **Étape 4 — lancer les validations finales.**
...
- [x] **Étape 5 — cocher toutes les cases du plan et commiter.**
