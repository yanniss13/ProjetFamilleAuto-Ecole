...
CREATE TABLE "new_School" (
    ...
    "siretStatus" TEXT NOT NULL DEFAULT 'unverified',
    "siretVerifiedName" TEXT,
    "siretCheckedAt" DATETIME,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_School" ("address", "businessName", "createdAt", "email", "emailVerified", "id", "latitude", "longitude", "passwordHash", "phone", "resetTokenExpiry", "resetTokenHash", "siret", "suspended", "updatedAt", "verifyTokenExpiry", "verifyTokenHash") SELECT "address", "businessName", "createdAt", "email", "emailVerified", "id", "latitude", "longitude", "passwordHash", "phone", "resetTokenExpiry", "resetTokenHash", "siret", "suspended", "updatedAt", "verifyTokenExpiry", "verifyTokenHash" FROM "School";
DROP TABLE "School";
